...
def preprocessing_fn(inputs):
    ...
    for feature in _SCALE_MINMAX_FEATURE_KEYS:
        ...
        features_dict[_transformed_name(feature)] = tft.scale_by_min_max(x=data_col)

    for feature in _SCALE_01_FEATURE_KEYS:
        data_col = inputs[feature] 
        # Transform using scaling of 0 to 1 function
        # Hint: tft.scale_to_0_1
        features_dict[_transformed_name(feature)] = tft.scale_to_0_1(x=data_col)

    for feature in _SCALE_Z_FEATURE_KEYS:
        data_col = inputs[feature] 
        # Transform using scaling to z score
        # Hint: tft.scale_to_z_score
        features_dict[_transformed_name(feature)] = tft.scale_to_z_score(x=data_col)
    ...
    for feature in _VOCAB_FEATURE_KEYS:
        ...
        features_dict[_transformed_name(feature)] = tft.compute_and_apply_vocabulary(x=data_col)
    ...
    for feature in _HASH_STRING_FEATURE_KEYS:
        ...
        features_dict[_transformed_name(feature)] = tft.hash_strings(strings = data_col, hash_buckets= 10)
